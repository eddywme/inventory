@extends('layouts.app')
@section('title', 'Items Overdue List')
@section('styles')
    ...
    <div class="container">
        ...
        <div class="row main-content">
            <div class="col-md-12">
                ...
                <h1 class="page-header"> <strong>OVERDUE ITEMS ASSIGNMENTS</strong> </h1>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped" id="assigned_items_table" style="font-size: 13px">
                        <thead>
                        <tr>
                            <th>Item Info</th><th>Assigned To</th><th>Time Info</th><th>Assigned By</th>


                        </tr>
                        </thead>
                        <tbody>
                        @foreach($overdueAssignments as $itemAssignment)
                            @php
